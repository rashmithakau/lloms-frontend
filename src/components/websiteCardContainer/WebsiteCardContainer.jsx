...
import "./WebsiteCardContainer.css";
          ...
          <div className="w-full bg-white shadow-lg rounded-lg overflow-auto px-6 py-6 mx-7">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex justify-center items-center w-12 h-12">
                    <button
                        className="prev-arrow flex items-center justify-center w-full h-full bg-gray-50 rounded-full shadow-md hover:bg-gray-300"
                ...
                <div className="flex justify-center items-center w-12 h-12">
                    <button
                        className="next-arrow flex items-center justify-center w-full h-full bg-gray-50 rounded-full shadow-md hover:bg-gray-300"
