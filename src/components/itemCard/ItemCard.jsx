...
function ItemCard() {
  return (
    <div className="border-[2px] shadow-md border-pink-200 rounded-b-lg bg-white flex flex-col items-start space-y-2 transition-transform transform hover:scale-110 hover:shadow-lg hover:border-pink-500">
      <img
        src={image}
        alt="Product"
